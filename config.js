(function () {
  ...
  window.NineNetConfig = Object.freeze({
    ...
    graphUserUrl: "https://graph.microsoft.com/v1.0/me?$select=displayName,jobTitle,mail,userPrincipalName,businessPhones,faxNumber,mobilePhone,department,officeLocation",
