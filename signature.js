(function (global) {
  ...
  function buildHtml(profile, config) {
    ...
    // Mantem exatamente a tipografia e as medidas da assinatura classica via GPO.
    ...
    var mobileRow = mobile
      ? '<tr><td width="52" valign="middle" style="width:52px;padding:6px 0;"><img class="theme-icon" src="' + assets + '/icon-mobile.png" width="24" height="24" alt="Celular" style="display:block;width:24px;height:24px;border:0;outline:none;background-color:#ffffff;"></td><td colspan="3" width="257" valign="middle" style="width:257px;padding:6px 0;font-family:\'Segoe UI\',Arial,sans-serif;font-size:14px;line-height:20px;"><a class="theme-link" href="' + escapeHtml(toTelHref(mobile)) + '" style="color:#222222!important;font-family:\'Segoe UI\',Arial,sans-serif;font-size:14px;line-height:20px;text-decoration:none;">' + escapeHtml(mobile) + "</a></td></tr>"
      : "";
    ...
    return '' +
      ...
      '</style>' +
      '<div class="WordSection1" data-9net-signature="new-outlook-v2.0.7">' +
      ...
      '<tr><td height="14" style="height:14px;font-size:1px;line-height:14px;mso-line-height-rule:exactly;background-color:#ffffff;">&nbsp;</td></tr>' +
      ...
      phoneRow +
      mobileRow +
      '<tr><td colspan="4" width="309" valign="middle" style="width:309px;padding:6px 0;background-color:#ffffff;font-size:0;line-height:0;mso-padding-alt:6px 0 6px 0;"><table role="presentation" align="left" width="112" height="28" cellpadding="0" cellspacing="0" border="0" style="width:112px;height:28px;table-layout:fixed;margin:0;background-color:#ffffff;"><tr>' +
      '<td width="44" height="28" align="left" valign="middle" style="width:44px;height:28px;padding:2px 0;background-color:#ffffff;font-size:0;line-height:0;mso-line-height-rule:exactly;"><a href="' + escapeHtml(config.websiteUrl) + '" target="_blank" aria-label="Site 9Net" style="display:block;width:24px;height:24px;line-height:24px;text-decoration:none;border:0;"><img class="theme-icon" src="' + assets + '/icon-website.png" width="24" height="24" alt="Site" style="display:block;width:24px;height:24px;border:0;outline:none;background-color:#ffffff;"></a></td>' +
      '<td width="44" height="28" align="left" valign="middle" style="width:44px;height:28px;padding:2px 0;background-color:#ffffff;font-size:0;line-height:0;mso-line-height-rule:exactly;"><a href="' + escapeHtml(config.linkedinUrl) + '" target="_blank" aria-label="LinkedIn 9Net" style="display:block;width:24px;height:24px;line-height:24px;text-decoration:none;border:0;"><img class="theme-icon" src="' + assets + '/icon-linkedin.png" width="24" height="24" alt="LinkedIn" style="display:block;width:24px;height:24px;border:0;outline:none;background-color:#ffffff;"></a></td>' +
      '<td width="24" height="28" align="left" valign="middle" style="width:24px;height:28px;padding:2px 0;background-color:#ffffff;font-size:0;line-height:0;mso-line-height-rule:exactly;"><a href="' + escapeHtml(config.instagramUrl) + '" target="_blank" aria-label="Instagram 9Net" style="display:block;width:24px;height:24px;line-height:24px;text-decoration:none;border:0;"><img class="theme-icon" src="' + assets + '/icon-instagram.png" width="24" height="24" alt="Instagram" style="display:block;width:24px;height:24px;border:0;outline:none;background-color:#ffffff;"></a></td>' +
