(function (global) {
  ...
  function buildHtml(profile, config) {
    ...
    // Layout visual original do Novo Outlook: mais amplo, com tipografia maior.
    // Mantem somente a formatacao de endereco introduzida no patch 2.0.7.
    var jobTitleBlock = jobTitle
      ? '<div class="theme-text-secondary" style="margin:2px 0 0 0;color:#555555!important;font-family:\'Segoe UI\',Arial,sans-serif;font-size:18px;line-height:23px;font-weight:600;mso-line-height-rule:exactly;">' + escapeHtml(jobTitle) + "</div>"
      : "";

    var phoneCells = fax
      ? '<td width="160" valign="middle" nowrap style="width:160px;padding:8px 0;background-color:#ffffff;font-family:\'Segoe UI\',Arial,sans-serif;font-size:18px;line-height:24px;mso-line-height-rule:exactly;white-space:nowrap;"><a class="theme-link" href="' + escapeHtml(toTelHref(phone)) + '" style="color:#222222!important;font-family:\'Segoe UI\',Arial,sans-serif;font-size:18px;line-height:24px;text-decoration:none;white-space:nowrap;">' + escapeHtml(phone) + '</a></td><td class="theme-text-primary" width="29" valign="middle" nowrap style="width:29px;padding:8px 0;background-color:#ffffff;color:#222222!important;font-family:\'Segoe UI\',Arial,sans-serif;font-size:18px;line-height:24px;mso-line-height-rule:exactly;white-space:nowrap;">|</td><td class="theme-text-primary" width="171" valign="middle" nowrap style="width:171px;padding:8px 0;background-color:#ffffff;color:#222222!important;font-family:\'Segoe UI\',Arial,sans-serif;font-size:18px;line-height:24px;mso-line-height-rule:exactly;white-space:nowrap;">Ramal ' + escapeHtml(fax) + "</td>"
      : '<td colspan="3" width="360" valign="middle" nowrap style="width:360px;padding:8px 0;background-color:#ffffff;font-family:\'Segoe UI\',Arial,sans-serif;font-size:18px;line-height:24px;mso-line-height-rule:exactly;white-space:nowrap;"><a class="theme-link" href="' + escapeHtml(toTelHref(phone)) + '" style="color:#222222!important;font-family:\'Segoe UI\',Arial,sans-serif;font-size:18px;line-height:24px;text-decoration:none;white-space:nowrap;">' + escapeHtml(phone) + "</a></td>";

    var phoneRow = phone
      ? '<tr><td width="52" valign="middle" style="width:52px;padding:8px 0;background-color:#ffffff;"><img class="theme-icon" src="' + assets + '/icon-phone.png" width="24" height="24" alt="Telefone" style="display:block;width:24px;height:24px;border:0;outline:none;background-color:#ffffff;"></td>' + phoneCells + "</tr>"
      : "";

    var mobileRow = mobile
      ? '<tr><td width="52" valign="middle" style="width:52px;padding:8px 0;background-color:#ffffff;"><img class="theme-icon" src="' + assets + '/icon-mobile.png" width="24" height="24" alt="Celular" style="display:block;width:24px;height:24px;border:0;outline:none;background-color:#ffffff;"></td><td colspan="3" width="360" valign="middle" style="width:360px;padding:8px 0;background-color:#ffffff;font-family:\'Segoe UI\',Arial,sans-serif;font-size:18px;line-height:24px;"><a class="theme-link" href="' + escapeHtml(toTelHref(mobile)) + '" style="color:#222222!important;font-family:\'Segoe UI\',Arial,sans-serif;font-size:18px;line-height:24px;text-decoration:none;white-space:nowrap;">' + escapeHtml(mobile) + "</a></td></tr>"
      : "";
    ...
    return '' +
      ...
      '@media only screen and (max-width:900px){.signature-shell{width:100%!important;max-width:880px!important}.banner-image{width:100%!important;height:auto!important}.contact-grid{width:100%!important}.stack-column{display:block!important;width:100%!important;max-width:100%!important}.address-cell{border-left:0!important;border-top:1px solid #dddddd!important;padding:16px 0 0 0!important}.contact-cell{padding:0 0 16px 0!important}}' +
      '</style>' +
      '<div class="WordSection1" data-9net-signature="new-outlook-v2.0.8">' +
      '<table role="presentation" class="signature-shell" width="880" cellpadding="0" cellspacing="0" border="0" style="width:880px;max-width:880px;background-color:#ffffff;font-family:\'Segoe UI\',Arial,sans-serif;">' +
      '<tr><td style="padding:0;background-color:#ffffff;"><a href="' + escapeHtml(config.websiteUrl) + '" target="_blank" style="text-decoration:none;border:0;"><img class="banner-image" src="' + assets + '/banner-9net.jpg" width="880" height="126" alt="9Net Tecnologia - Cuidamos do seu TI para que o foco e investimento da sua empresa estejam em seus negocios." style="display:block;width:880px;max-width:880px;height:126px;border:0;outline:none;text-decoration:none;"></a></td></tr>' +
      '<tr><td style="padding:31px 0 0 0;background-color:#ffffff;"><div class="theme-text-primary" style="margin:0;color:#111111!important;font-family:\'Segoe UI\',Arial,sans-serif;font-size:24px;line-height:29px;font-weight:700;mso-line-height-rule:exactly;">' + displayName + '</div>' + jobTitleBlock + '</td></tr>' +
      '<tr><td height="19" style="height:19px;font-size:1px;line-height:19px;mso-line-height-rule:exactly;background-color:#ffffff;">&nbsp;</td></tr>' +
      '<tr><td style="padding:0;background-color:#ffffff;"><table role="presentation" class="contact-grid" width="880" cellpadding="0" cellspacing="0" border="0" style="width:880px;table-layout:fixed;background-color:#ffffff;"><tr>' +
      '<td class="stack-column contact-cell" width="440" valign="top" style="width:412px;padding:9px 28px 0 0;mso-padding-alt:9px 28px 0 0;background-color:#ffffff;"><table role="presentation" width="412" cellpadding="0" cellspacing="0" border="0" style="width:412px;table-layout:fixed;background-color:#ffffff;">' +
      '<tr><td width="52" valign="middle" style="width:52px;padding:8px 0;background-color:#ffffff;"><img class="theme-icon" src="' + assets + '/icon-email.png" width="24" height="24" alt="E-mail" style="display:block;width:24px;height:24px;border:0;outline:none;background-color:#ffffff;"></td><td colspan="3" width="360" valign="middle" style="width:360px;padding:8px 0;background-color:#ffffff;font-family:\'Segoe UI\',Arial,sans-serif;font-size:18px;line-height:24px;"><a class="theme-link" href="mailto:' + escapeHtml(email) + '" style="color:#222222!important;font-family:\'Segoe UI\',Arial,sans-serif;font-size:18px;line-height:24px;text-decoration:none;word-break:break-word;">' + escapeHtml(email) + '</a></td></tr>' +
      phoneRow +
      mobileRow +
      '<tr><td colspan="4" width="412" valign="middle" style="width:412px;padding:8px 0;background-color:#ffffff;font-size:0;line-height:0;mso-padding-alt:8px 0 8px 0;"><table role="presentation" align="left" width="112" height="24" cellpadding="0" cellspacing="0" border="0" style="width:112px;height:24px;table-layout:fixed;margin:0;background-color:#ffffff;"><tr>' +
